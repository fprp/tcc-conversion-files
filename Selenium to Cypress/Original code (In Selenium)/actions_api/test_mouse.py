...
def test_move_by_offset_from_element(driver):
    ...
    print(coordinates)
    print(abs(int(coordinates[0]) - 100 - 8))
...
test_forward_click_ab(driver)
test_double_click(driver)
test_hover(driver)
test_move_by_offset_from_element(driver)
test_move_by_offset_from_viewport_origin_ab(driver)
test_move_by_offset_from_current_pointer_ab(driver)
